const text = "Stefan Popovski (Стефан Поповски)";
let index = 0;
...
async function fetchDetails(typingSpeed = 100) {
    const detailsArray = [
        ...
        "Location: College Park, U.S.A",
        "Interests: Nuclear Power, Oil and Gas, Vessels Under Pressure, off-shore.",
        "Status: Looking for opportunities and experience!",
        "User info retrieved.",
...
// Function to fetch the user's IP, location, and time
